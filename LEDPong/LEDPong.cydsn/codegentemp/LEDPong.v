// ======================================================================
// LEDPong.v generated from TopDesign.cysch
// 04/09/2014 at 10:48
...
module CharLCD_v1_90_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("1d3b8d17-05bb-4858-ad4f-18ecfc6cfbf8/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    UART_v2_30_0 PlayerBT1 (
        ...
        .rx_data(Net_34),
        .rx_clk(Net_35));
    defparam PlayerBT1.Address1 = 0;
    defparam PlayerBT1.Address2 = 0;
    defparam PlayerBT1.EnIntRXInterrupt = 0;
    defparam PlayerBT1.EnIntTXInterrupt = 0;
    defparam PlayerBT1.FlowControl = 0;
    defparam PlayerBT1.HalfDuplexEn = 0;
    defparam PlayerBT1.HwTXEnSignal = 0;
    defparam PlayerBT1.NumDataBits = 8;
    defparam PlayerBT1.NumStopBits = 1;
    defparam PlayerBT1.ParityType = 0;
    defparam PlayerBT1.RXEnable = 1;
    defparam PlayerBT1.TXEnable = 1;

	wire [0:0] tmpOE__PlayerBTRx1_net;
	wire [0:0] tmpIO_0__PlayerBTRx1_net;
	wire [0:0] tmpINTERRUPT_0__PlayerBTRx1_net;
	electrical [0:0] tmpSIOVREF__PlayerBTRx1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .width(1))
		PlayerBTRx1
		 (.oe(tmpOE__PlayerBTRx1_net),
		  .y({1'b0}),
		  .fb({Net_7}),
		  .io({tmpIO_0__PlayerBTRx1_net[0:0]}),
		  .siovref(tmpSIOVREF__PlayerBTRx1_net),
		  .interrupt({tmpINTERRUPT_0__PlayerBTRx1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PlayerBTRx1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PlayerBTTx1_net;
	wire [0:0] tmpFB_0__PlayerBTTx1_net;
	wire [0:0] tmpIO_0__PlayerBTTx1_net;
	wire [0:0] tmpINTERRUPT_0__PlayerBTTx1_net;
	electrical [0:0] tmpSIOVREF__PlayerBTTx1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .width(1))
		PlayerBTTx1
		 (.oe(tmpOE__PlayerBTTx1_net),
		  .y({Net_2}),
		  .fb({tmpFB_0__PlayerBTTx1_net[0:0]}),
		  .io({tmpIO_0__PlayerBTTx1_net[0:0]}),
		  .siovref(tmpSIOVREF__PlayerBTTx1_net),
		  .interrupt({tmpINTERRUPT_0__PlayerBTTx1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PlayerBTTx1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("084db1d3-4a76-4f68-9ec5-8d9d0db16d16"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("3257328990.22801"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_1
		 (.clock_out(Net_28));
